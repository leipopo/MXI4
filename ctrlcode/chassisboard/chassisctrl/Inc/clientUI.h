...
} __attribute__((packed)) UI_Packhead;
...
} __attribute__((packed)) UI_Data_Operate;
...
typedef struct
{
    ...
    uint8_t Layer;                  //删除图层
} __attribute__((packed)) UI_Data_Delete;          //删除图层帧
...
} __attribute__((packed)) Graph_Data;
...
} __attribute__((packed)) String_Data;                  //打印字符串数据
 ...
 *  @param[in]      图层数 [0, 9]
 */
extern void UI_delete(uint8_t operate, uint8_t layer);
 ...
 *  @retval         none
 */
extern void Line_Draw(Graph_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_Width, uint32_t Start_x, uint32_t Start_y, uint32_t End_x, uint32_t End_y);
 ...
 *  @retval         none
 */
extern void Circle_Draw(Graph_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_Width, uint32_t Start_x, uint32_t Start_y, uint32_t Graph_Radius);
 ...
 *  @retval         none
 */
extern void Arc_Draw(Graph_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_StartAngle, uint32_t Graph_EndAngle, uint32_t Graph_Width, uint32_t Start_x, uint32_t Start_y, uint32_t x_Length, uint32_t y_Length);
 ...
 *  @return         none
 */
extern void Rectangle_Draw(Graph_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_Width, uint32_t Start_x, uint32_t Start_y, uint32_t End_x, uint32_t End_y);

extern void Float_Draw(Float_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_Size, uint32_t Graph_Digit, uint32_t Graph_Width, uint32_t Start_x, uint32_t Start_y, float Graph_Float);
 ...
 *  @retval         none
 */
extern void string_Draw(String_Data* image, char imagename[3], uint32_t Graph_Operate, uint32_t Graph_Layer, uint32_t Graph_Color, uint32_t Graph_Size, uint32_t Graph_Digit, uint32_t Start_x, uint32_t Start_y, char* Char_Data);
/**
 *  @brief          使用自定义UI绘制一个图形，刷新出来在屏幕上显示
 *  @param[in]      图形
 *  @return         none
 */
extern void ui_display_1_graph(Graph_Data* graph1);
 ...
 *  @return         none
 */
extern void ui_display_2_graph(Graph_Data* graph1, Graph_Data* graph2);
 ...
 *  @return         none
 */
extern void ui_display_5_graph(Graph_Data* graph1, Graph_Data* graph2, Graph_Data* graph3, Graph_Data* graph4, Graph_Data* graph5);
 ...
 *  @return         none
 */
extern void ui_display_7_graph(Graph_Data* graph1, Graph_Data* graph2, Graph_Data* graph3, Graph_Data* graph4, Graph_Data* graph5, Graph_Data* graph6, Graph_Data* graph7);
 ...
 *  @return         none
 */
extern void ui_display_string(String_Data* str_data);
